...
export const PRODUCTS: Product[] = [
  ...
  { id: "claude-for-business-practical-playbook",  name: "Claude for Business: The Practical Playbook",                      price: 19.99, category: "Business",    description: "Real workflows for using Claude in business: document analysis, proposal writing, client communications, and building a persistent AI assistant that knows your business." },
  { id: "ai-agents-for-small-business",            name: "AI Agents for Small Business",                                     price: 19.99, category: "Business",    description: "Plain-English guide to deploying your first AI agent -- lead follow-up, proposal generation, triage, and automation -- in 30 days with no code required." },
  { id: "cursor-ai-coding-guide",                  name: "Build It Without Code: A Non-Developer's Guide to Cursor",         price: 19.99, category: "Business",    description: "Use Cursor and AI to build landing pages, internal tools, intake forms, and data dashboards -- without hiring a developer or learning to code." },
  { id: "copilot-cowork-microsoft-365-team-guide", name: "Copilot as a Coworker: The Microsoft 365 Team Collaboration Guide", price: 19.99, category: "Microsoft",  description: "Team-level Copilot deployment for Microsoft 365: meeting recaps, collaborative documents, Copilot Pages, and shared prompt libraries that make AI output consistent across your whole team." },
  { id: "free-ai-stack-small-business-setup",      name: "The Free AI Stack: An End-to-End AI Setup for Small Business",    price: 14.99, category: "Business",    description: "Build a complete five-tool AI stack -- writing, visuals, automation, inbox, and organization -- for $0 using Claude, Gemini, Canva, Zapier, and Notion free tiers." },
  { id: "jumpstart-business-ai-under-100",         name: "Jumpstart Your Business with AI for Under $100 a Month",          price: 14.99, category: "Business",    description: "Concentrate your AI budget into two or three tools that cover 90% of small business needs. Claude Pro, Zapier Starter, and one specialized tool -- wired together and producing ROI in week one." },
  { id: "enterprise-ai-deployment-guide",          name: "Enterprise AI Deployment: The Complete Implementation Guide",     price: 29.99, category: "Business",    description: "An 8-phase enterprise AI deployment framework covering use case selection, vendor evaluation, security and compliance, pilot design, change management, phased rollout, and ROI measurement." },
];
