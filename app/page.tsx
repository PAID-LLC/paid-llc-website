        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-16">
            {[
              ...
              <div key={myth} className="bg-white border border-ash rounded-xl p-8 hover:border-primary transition-colors">
          ...
          <div className="border-t border-stone/20 pt-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
              {[
                ...
                { stat: "~60%",          label: "Projected data center energy growth that will come from fossil fuels", source: "Goldman Sachs Research" },
